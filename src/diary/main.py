def main():
    ...
    def write():
        ...
        with open("." + date + ".txt", "w") as file: # if you are not using a unix based operating system, remove: "."
    ...
    def read():
        ...
        try:
            with open("." + which + ".txt", "r") as file: # if you are not using a unix based operating system, remove: "."
                a = file.read()
                print (a)
